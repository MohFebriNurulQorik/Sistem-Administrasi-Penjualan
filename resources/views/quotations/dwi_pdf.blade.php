    ...
    <div class="content">
        ...
        <table class="info-container">
            <tr>
                ...
                <td style="width: 18%;padding: 0 15px; border-left: 1px solid #ddd;">
                    Quotation #<br>
                    Valid Until<br>
                    Project
                </td>
        ...
        <p>Please find the prices below of <span>{{ $quotation->project }}</span></p>
        ...
        <div class="sig-section">
            ...
            PT Dwipantara Selaras Nusantara
        </div>
    </div>
